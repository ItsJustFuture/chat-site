...
- `PGSSL_REJECT_UNAUTHORIZED` - Set to `1`, `true`, or `yes` to enforce cert verification (defaults to enabled in production, disabled otherwise; set to `0`/`false` to explicitly disable)
